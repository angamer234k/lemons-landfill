...
function validateActions(actions) {
  ...
  const ok = new Set(['reply','edit_reply','dm','add_role','remove_role','react','wait','condition','send_channel']);
...
function normAction(a) {
  ...
  if (a.type === 'condition') {
    return {
      ...base,
      when: ['has_role','missing_role','is_owner','option_equals'].includes(a.when) ? a.when : 'has_role',
